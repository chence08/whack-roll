		...
		if canScroll:
			...
			if isCenter:
				self.scroll_buttons.append(
					Button(name, ret, pos, size, key, colour, font, font_colour, hl_colour, sel_colour).align_ctr())
			else:
				self.scroll_buttons.append(
					Button(name, ret, pos, size, key, colour, font, font_colour, hl_colour, sel_colour))
